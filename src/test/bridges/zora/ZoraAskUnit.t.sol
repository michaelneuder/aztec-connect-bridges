...
import {ZoraAskBridge} from "../../../bridges/zora/ZoraAskBridge.sol";
import {ZoraAsk} from "../../../bridges/zora/ZoraAskBridge.sol";

// @notice The purpose of this test is to directly test convert functionality of the bridge.
contract ZoraAskUnitTest is BridgeTestBase {
    ...
    function setUp() public {
        ...
        ask = new ZoraAsk();
        bridge = new ZoraAskBridge(rollupProcessor, address(ask), address(registry));
        ...
        // Register 0xdeadbeef, which we use as a fake consumer address.
        ...
        // Register the nftContract address. This is the collection of our fake NFTs.
